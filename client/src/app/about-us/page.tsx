...
export default function AboutUsPage() {
  return (
    <div suppressHydrationWarning className="flex flex-col min-h-screen">
      ...
      <header suppressHydrationWarning className="px-6 md:px-12 py-8 md:py-12 border-b border-[#E2ECE6]">
      ...
      <main suppressHydrationWarning className="flex-grow px-6 md:px-12 py-8 md:py-12">
