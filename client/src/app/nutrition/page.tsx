  ...
  return (
    <div suppressHydrationWarning className="p-6 md:p-12">
      <div suppressHydrationWarning className="max-w-3xl border-b border-divider pb-12 mb-12">
        <h2 suppressHydrationWarning className="text-xl font-bold uppercase tracking-wider text-foreground mb-4">Domain 01</h2>
        <h1 suppressHydrationWarning className="text-4xl md:text-5xl font-serif text-foreground mb-6">Nutritional Biochemistry</h1>
      ...
      <div suppressHydrationWarning className="grid grid-cols-1 md:grid-cols-2 gap-12">
        <ArchFrame className="w-full aspect-square bg-nutrition/10 flex items-center justify-center">
            <img suppressHydrationWarning src="/images/nutrition_illustration.jpg" alt="Metabolism Asset" className="w-full h-full object-cover opacity-90" />
        </ArchFrame>
        <div suppressHydrationWarning className="flex flex-col justify-center">
            <h3 suppressHydrationWarning className="font-serif text-2xl mb-4">Metabolic Flexibility</h3>
            ...
            <a suppressHydrationWarning href="/archive?domain=nutrition" className="text-xs uppercase tracking-widest text-action border-b border-nutrition/40 self-start pb-1">View Domain Archive</a>
        </div>
      </div>
    </div>
  );
